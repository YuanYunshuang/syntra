...
from training.utils.data_utils import SrcTgtDatapoint
...
class ToTensorAPI:
    ...
    def __call__(self, datapoint: SrcTgtDatapoint, **kwargs):
...
class RandomAffine:
    ...
    def transform_datapoint(self, datapoint: SrcTgtDatapoint):
